...
class Configuration:
    ...
    def __init__(self) -> None:
        ...
        self.load_env()
        self.api_key = os.getenv("NAI_API_KEY")
...
class LLMClient:
    ...
    def __init__(self, api_key: str) -> None:
        ...
        self.base_url = "https://ai.nutanix.com/api/v1"
        self.model = "vllm-llama-3-1-8b"  # Update this to your specific model
    ...
    def get_response(self, messages: List[Dict[str, str]]) -> str:
        ...
        try:
            ...
            if e.response is not None:
                ...
                logging.error(f"Response details: {response_text}")
                
                # Try to parse error details if available
                try:
                    error_details = json.loads(response_text)
                    if 'error' in error_details:
                        error_message = f"LLM Error: {error_details['error']}"
